...
sp_model_root='tokenized_sp_%s' % (model_name)
if not os.path.isdir(sp_model_root):
    os.mkdir(sp_model_root)
sp_model_name = 'tokenized_%s' % (model_name)
...
cmd = input_argument%(args.input, sp_model_path, vocab_size, user_defined_symbols, model_type, character_coverage)
