...
#         tokenized_lines.append(SPP.EncodeAsPieces(lines))
                        
#     return tokenized_lines

# def tokenize_de(text_list):
#     tokenized_lines = []
